...
Color, typography, decoration, and internal padding are the governed families; layout (display, flex/grid arrangement, dimensions, margin, position) is deliberately absent, because a primitive has no opinion on how it sits relative to its neighbors and must not pretend to.
