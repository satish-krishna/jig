...
export const COMPONENTS: readonly ComponentEntry[] = [
  ...
  // Forms
  { slug: 'field', name: 'Field', category: 'Forms', blurb: 'Label, control, description and error anatomy.', documented: true },
  { slug: 'label', name: 'Label', category: 'Forms', blurb: 'Control labelling.', documented: true },
  { slug: 'input', name: 'Input', category: 'Forms', blurb: 'Single-line text entry.', documented: true },
  { slug: 'textarea', name: 'Textarea', category: 'Forms', blurb: 'Multi-line text entry.', documented: true },
  { slug: 'native-select', name: 'Native select', category: 'Forms', blurb: 'The platform select, styled.', documented: true },
  { slug: 'select', name: 'Select', category: 'Forms', blurb: 'Overlay-based select with rich items.', documented: true },
  { slug: 'combobox', name: 'Combobox', category: 'Forms', blurb: 'Filterable select, single or multiple.', documented: true },
  { slug: 'autocomplete', name: 'Autocomplete', category: 'Forms', blurb: 'Free text with suggestions.', documented: true },
  { slug: 'checkbox', name: 'Checkbox', category: 'Forms', blurb: 'Binary and indeterminate states.', documented: true },
  { slug: 'radio-group', name: 'Radio group', category: 'Forms', blurb: 'One choice from a small set.', documented: true },
  { slug: 'switch', name: 'Switch', category: 'Forms', blurb: 'Immediate on/off toggle.', documented: true },
  { slug: 'slider', name: 'Slider', category: 'Forms', blurb: 'Single value or range.', documented: true },
  { slug: 'input-group', name: 'Input group', category: 'Forms', blurb: 'Input with addons and inline buttons.', documented: true },
  { slug: 'input-otp', name: 'Input OTP', category: 'Forms', blurb: 'One-time-code entry.', documented: true },
  { slug: 'date-picker', name: 'Date picker', category: 'Forms', blurb: 'Single date, range and multi.', documented: true },
  { slug: 'calendar', name: 'Calendar', category: 'Forms', blurb: 'Inline month grid.', documented: true },
