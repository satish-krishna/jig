  ...
  template: `
    <app-component-page slug="separator">
      <app-usage
        ...
        [code]="codeHorizontal"
      >
        <div class="grid max-w-sm gap-4 text-sm">
      ...
      <app-usage
        ...
        [code]="codeList"
      >
        <div class="grid w-full max-w-sm gap-2 text-sm">
      ...
      >
        <div class="grid grid-flow-col auto-cols-auto items-center gap-4 text-sm">
...
<dl class="grid grid-cols-[1fr_auto] items-center">
  ...
  protected readonly codeComposition = `<div class="grid grid-flow-col auto-cols-auto items-center gap-4 text-sm">
  <div class="flex flex-col gap-1">
    <span class="font-medium">Settings</span>
    <span class="text-muted-foreground text-xs">Manage preferences</span>
  </div>
